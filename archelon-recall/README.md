...
CLI tool and MCP server for indexing and searching arbitrary text files, built on [archelon-retrieve](../archelon-retrieve).
...
`$XDG_CONFIG_HOME/archelon-recall/config.toml`
