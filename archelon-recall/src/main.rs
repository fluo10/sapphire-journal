...
#[derive(Parser)]
#[command(name = "archelon-recall", about = "Index and search text files with FTS and semantic search")]
struct Cli {
    /// Workspace directory to index (env: ARCHELON_RECALL_WORKSPACE).
    ///
    /// When omitted and running in a terminal, you will be prompted to confirm
    /// using the current directory.
    #[arg(long, env = "ARCHELON_RECALL_WORKSPACE", global = true, value_name = "DIR")]
