...
export async function activate(context: vscode.ExtensionContext) {
    ...
    const treeView = vscode.window.createTreeView('sapphire-journal.entries', {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.sortTree', async () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.filterTree', async () => {
    ...
    // ── Command: New Entry ────────────────────────────────────────────────────
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.newEntry', async () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.newChildEntry', async (item?: EntryItem) => {
            const cwd = getJournalCwd();
            if (!cwd) {
                vscode.window.showErrorMessage('Archelon: no workspace folder open.');
                return;
    ...
    // ── Command: Open Entry ───────────────────────────────────────────────────
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.openEntry', async () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.removeEntry', async (item?: EntryItem) => {
            let entryArg: string;
            let cwd: string;
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.setPeriod', async () => {
    ...
    const switchViewMode = (mode: 'tree' | 'list') => {
        ...
        vscode.commands.executeCommand('setContext', 'sapphire-journal.viewMode', mode);
    };
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.showListView', () => switchViewMode('list'))
    );
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.showTreeView', () => switchViewMode('tree'))
    );

    // ── Command: List Entries ─────────────────────────────────────────────────
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.listEntries', async () => {
            const cwd = getJournalCwd();
            if (!cwd) {
                vscode.window.showErrorMessage('Archelon: no workspace folder open.');
                return;
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.init', async () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.cacheRebuild', async () => {
            const cwd = getJournalCwd();
            if (!cwd) {
                vscode.window.showErrorMessage('Archelon: no workspace folder open.');
                return;
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('sapphire-journal.searchEntries', async () => {
            const cwd = getJournalCwd();
            if (!cwd) {
                vscode.window.showErrorMessage('Archelon: no workspace folder open.');
                return;
